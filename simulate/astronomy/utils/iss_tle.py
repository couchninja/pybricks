...
def resolve_iss_tle_lines() -> tuple[str, str, str]:
    ...
    except IssTleNetworkUnavailable:
        _network_retry_after_monotonic = now + ISS_TLE_NETWORK_RETRY_INTERVAL_S
        return _load_fallback_tle_lines("CelesTrak unreachable")
