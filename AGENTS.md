...
- Before connecting to or testing the LEGO Move Hub (e.g. `pixi run starpoint`, `pixi run test-hub`, hub-upload/hub-run), ask the user to put the brick in receiving mode and wait for confirmation. Do not attempt a hub connection until they say it is ready.
